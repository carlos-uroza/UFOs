...
// Create function to fill the table with data
function buildTable(data) {

    // First, clear out any existing data
    tbody.html("");

    // Loops through our data array, and then appends a row and cells for each value in the row
...
function handleClick() {
    ...
    // Reset the table to original unsorted data
